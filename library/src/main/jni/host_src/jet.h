...
JET_Init(EAS_DATA_HANDLE easHandle, const S_JET_CONFIG *pConfig, EAS_INT configSize);
...
*/
EAS_PUBLIC EAS_BOOL
JET_GetEvent(EAS_DATA_HANDLE easHandle, EAS_U32 *pEventRaw, S_JET_EVENT *pEvent);
...
*/
EAS_PUBLIC EAS_RESULT
JET_QueueSegment(EAS_DATA_HANDLE easHandle, EAS_INT segmentNum, EAS_INT libNum, EAS_INT repeatCount,
                 EAS_INT transpose, EAS_U32 muteFlags, EAS_U8 userID);
...
*/
EAS_PUBLIC EAS_RESULT
JET_SetMuteFlag(EAS_DATA_HANDLE easHandle, EAS_INT trackNum, EAS_BOOL muteFlag, EAS_BOOL sync);
