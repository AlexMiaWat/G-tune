...
*/
EAS_PUBLIC EAS_RESULT
EAS_SetTransposition(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 transposition);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_SetVolume(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 volume);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_OpenFile(EAS_DATA_HANDLE pEASData, EAS_FILE_LOCATOR locator, EAS_HANDLE *pStreamHandle);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_GetFileType(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 *pFileType);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_ParseMetaData(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 *pPlayLength);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_State(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_STATE *pState);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_GetNoteCount(EAS_DATA_HANDLE pEASData, EAS_HANDLE pStream, EAS_I32 *pNoteCount);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_OpenMIDIStream(EAS_DATA_HANDLE pEASData, EAS_HANDLE *pStreamHandle, EAS_HANDLE streamHandle);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_WriteMIDIStream(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_U8 *pBuffer,
                    EAS_I32 count);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_Locate(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 milliseconds,
           EAS_BOOL offset);
...
*/
EAS_PUBLIC EAS_RESULT
EAS_GetLocation(EAS_DATA_HANDLE pEASData, EAS_HANDLE streamHandle, EAS_I32 *pTime);
...
*/
EAS_RESULT
EAS_SearchFile(EAS_DATA_HANDLE pEASData, EAS_FILE_HANDLE fileHandle, const EAS_U8 *searchString,
               EAS_I32 len, EAS_I32 *pOffset);
